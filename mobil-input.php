						...
						<div class="col-md-12">
							...
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title">Create Data Mobil</h3>
								</div>
								<div class="panel-body">
                                <form action="proses-input-mobil.php" method="post">
                                <label>Merk</label>
                                <br>
                                ...
                                <br>                                
                                <button class="btn " type="reset">Reset</button><br><br>
                                <button class="btn" type="submit" name="submit_mobil">Submit</button>
