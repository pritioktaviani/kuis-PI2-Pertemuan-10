					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="panel">
								...
								<a href=member-input.php> Tambah Data </a>
									<table class="table table-striped">
                                        ...
                                        <tr>
											...
											<td><a name="edit" id="edit" class="btn btn-sm " href="edit_member.php?member_id=<?=$data->member_id ?>">Edit</a>
												<a name="hapus" id="hapus" class="btn btn-sm" href="hapus_member.php?member_id=<?=$data->member_id ?>">Delete</a>
											</tr>
										</tbody>
										<?php endforeach;
 											} else { ?>
